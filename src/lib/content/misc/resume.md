...
- **Languages:** Ruby, Go, JavaScript, TypeScript, Scheme
...
- Built a production **Email-Notification Service** using **microservices** and **event-driven architecture**, now used across multiple applications for outbound communication.
- Built and improved **Gmail/Outlook mail integrations** for [Lockstep Inbox](https://www.prnewswire.com/news-releases/lockstep-announces-worlds-first-smart-inbox-designed-for-accounting-teams-301549995.html), serving 2,500+ monthly active users.
